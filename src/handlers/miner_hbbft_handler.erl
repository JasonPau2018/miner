...
-record(state,
        {
         ...
         sigs_valid     = [] :: [{Addr :: binary(), Sig :: binary()}],
         sigs_invalid   = [] :: [{Addr :: binary(), Sig :: binary()}],
         sigs_unchecked = [] :: [{Addr :: binary(), Sig :: binary()}],
...
-type hbbft_msg_signature() ::
    {signature, Round :: pos_integer(), Address :: binary(), Signature :: binary()}.

-type hbbft_msg_signatures() ::
    {signatures, Round :: pos_integer(), [{Addr :: binary(), Sig :: binary()}]}.
